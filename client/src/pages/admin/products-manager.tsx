...
export default function ProductsManager() {
  ...
  const { searchQuery, setSearchQuery, searchProducts, clearSearch } = useProductStore();
  ...
  const handleSortBy = (sortBy: string) => {
    ...
    getProductsByCategory(selectedCategory, sortBy);
  }

  const handleCategoryChange = (category: string) => {
    setSelectedCategory(category);
    getProductsByCategory(category, currentSort);
  }
  ...
  useEffect(() => {
    getProductsByCategory(selectedCategory, currentSort);
    // eslint-disable-next-line react-hooks/exhaustive-deps
